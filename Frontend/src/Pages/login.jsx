...
return (
  <div className="min-h-screen bg-[#0B1120] flex items-center justify-center p-6">
    <div className="relative flex flex-col-reverse md:flex-row w-full md:w-[900px] overflow-hidden rounded-3xl border border-violet-500 shadow-[0_0_25px_rgba(168,85,247,0.4)] bg-[#111827]">

      {/* Left Side Form */}
      <div className="w-full md:w-[65%] p-6 md:p-10 md:ml-10 flex flex-col justify-center">
      ...
      {/* Right Side - decorative panel (desktop only, unchanged) */}
      <div className="relative hidden md:block md:w-[100%] min-h-[550px]">
        ...
        <div className="relative z-10 flex h-full flex-col justify-center items-end px-10 text-white text-right">
